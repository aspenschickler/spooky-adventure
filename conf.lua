...
function love.conf(t)
    ...
    t.window.title = "A Spooky Adventure!"         -- The window title (string)
    t.window.icon = "res/images/fileicon.png"                 -- Filepath to an image to use as the window's icon (string)
